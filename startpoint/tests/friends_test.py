...
class TestFriends(unittest.TestCase):
  ...
  def test_find_mutual_friends(self):
    self.assertEqual(["Velma", "Daphne"], find_mutual_friends(self.person1, self.person4))
  ...
  def test_find_people_who_like_tv_show(self):
    self.assertEqual([self.person4, self.person5], find_people_who_like_tv_show("X-Files", self.people))
